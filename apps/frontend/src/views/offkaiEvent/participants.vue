<template>
  ...
  <template v-else-if="detail">
    <OffkaiDetailHeader :offkai="detail.offkai" :has-answered="detail.viewer.isParticipant"
      :can-view-participant-guide="detail.viewer.permissions.canViewParticipantGuide"
      :can-manage-participants="canManageParticipants" compact />

    <main v-if="canManageParticipants" class="space-y-4">
